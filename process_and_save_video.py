# Nama file: process_and_save_video.py
...
out_original = cv2.VideoWriter('output_original.mp4', fourcc, fps, (w, h))
out_masked = cv2.VideoWriter('output_masked.mp4', fourcc, fps, (w, h))
